        ...
        <div id="page-content-wrapper">
            ...
            <body>
                {{-- <div class="container-fluid p-4">
                    <h1 class="page-title mb-4">Role Management</h1>
                    <div class="row g-4">
                        @foreach ($roles as $role)
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card role-card">
                                    <div class="card-body">
                                        <h5 class="card-title mb-2">{{ $role->name }}</h5>
                                        <p class="text-muted mb-3">{{ $role->description }}</p>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="badge bg-info">{{ count($role->permissions) }}
                                                Permissions</span>
...
<div class="container-fluid p-4">
    <div class="card">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('users.index') }}" class="btn btn-primary">Add New Role</a>
        </div>
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('users.index', $role) }}" class="btn btn-sm btn-info">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <form action="{{ route('users.index', $role) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
