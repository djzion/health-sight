            ...
            <body>
                <div class="container-fluid p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h1>Primary Health Centers</h1>
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createPHCModal">
                                    ...
                                    <tbody>
                                        @foreach ($phcs as $phc)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge {{ $phc->status === 'Functional' ? 'bg-success' : 'bg-danger' }}">
                                                        {{ ucfirst($phc->status) }}
                                                    </span>
                                                </td>
                                                <td>
                                                    <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#editPHCModal{{ $phc->id }}">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <button class="btn btn-sm btn-danger"
                                                        onclick="deletePHC({{ $phc->id }})">
