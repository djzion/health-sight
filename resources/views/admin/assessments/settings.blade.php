...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container p-4 setDate">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Set Next Assessment Date</h5>
                    </div>

                    <form action="{{ route('admin.assessments.set-next-date') }}" method="POST">
                        @csrf

                        <div class="card-body">
                            <div class="alert alert-info">
                                <i class="fas fa-info-circle me-2"></i>
                                Set the date when all assessments will next be available to users.
                            </div>

                            <div class="form-group mb-4">
                                <label for="next_date" class="form-label next_date"><strong>Next Assessment Date:</strong></label>
                                <input type="date" class="form-control" id="next_date"
                                       name="next_date" required
                                       value="{{ date('Y-m-d') }}">
                            </div>
                        </div>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-calendar-check me-2"></i>Set Date
                            </button>
                        </div>
                    </form>
                </div>
