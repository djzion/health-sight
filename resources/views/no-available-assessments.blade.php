...
<div class="container py-4">
    <div class="card">
        <div class="card-body text-center py-5">
            ...
            <h2 class="mb-4">No Assessments Available Right Now</h2>

            @if($nextAvailableDate)
                <p class="lead">
                    The next assessment will be available on
                    <strong>{{ $nextAvailableDate->format('F d, Y') }}</strong>
                    ({{ $nextAvailableDate->diffForHumans() }}).
                </p>

                <div class="alert alert-info mt-4">
                    Assessments are scheduled by Admin.
                    Please check back in {{ $daysRemaining }} day{{ $daysRemaining != 1 ? 's' : '' }}.
                </div>
            @else
                <p class="lead">
                    There are no assessments scheduled for your role at this time.
                </p>
                <div class="alert alert-info mt-4">
